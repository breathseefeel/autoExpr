...
extern CRITICAL_SECTION crtc;
extern CRITICAL_SECTION crtcCout;
...
public:  
	...
	friend unsigned int WINAPI TemOvenListener(void *pParam);
	friend unsigned int WINAPI CardInformer(void *pParam);
	friend unsigned int WINAPI McuComm(void *pParam);
	friend unsigned int WINAPI McuCommWithTemListner(void *pParam);
	friend unsigned int WINAPI Mcu(void *pParam);
	friend unsigned int WINAPI McuAndSensor(void *pParam);
	friend unsigned int WINAPI Card(void *pParam);
	friend unsigned int WINAPI TemSensorInOven(void *pParam);
	friend unsigned int WINAPI randomInqTem(void *pParam);
	friend unsigned int WINAPI testWave(void *pParam);
	friend bool receiveNum(CSerialPort *pSerialPort, char *rcv, int &nActual);
	...
	friend unsigned int WINAPI McuComm_Half_Auto(void *pParam);
